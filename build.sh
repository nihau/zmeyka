...
cat random.js colors.js helper.js point.js customEvent.js notifyable.js gameobject.js zmeyka_model.js zmeyka_controller.js zmeyka_view.js > ../zmeyka.ugly.js
